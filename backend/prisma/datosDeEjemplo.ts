...
/*
  Los datos de ejemplo de PamploHogar: arrendadores, estudiantes, inmuebles,
  resenas y opiniones de barrio.

  Estan aparte porque los usan DOS programas y tienen que ser los mismos:

    seed.ts            borra los ejemplos anteriores y los vuelve a crear
    agregarEjemplos.ts solo agrega lo que falta, sin borrar nada

  Si estuvieran copiados en los dos, con el tiempo se separarian y nadie sabria
  cual de las dos versiones es la buena.

  Todo esto es de mentiras y vive en cuentas @ejemplo.com. El dia que haya
  publicaciones y opiniones de verdad, esto sobra.
*/

export const foto = (id: string) => `https://images.unsplash.com/${id}?auto=format&fit=crop&w=1400&q=70`;

export interface SemillaInmueble {
  titulo: string;
  descripcion: string;
  tipo: TipoInmueble;
  precio: number;
...
*/
export const RESENAS_DE_BARRIO: {
  barrio: string;
...
export const INMUEBLES: SemillaInmueble[][] = [
